          ...
          <div className='mx-auto max-w-5xl text-center'>
            ...
            >
              <h1 className='mb-4 text-4xl font-black leading-tight text-white drop-shadow-lg md:text-6xl lg:text-7xl'>
                <span className='block'>Cơ sở vật chất</span>
                <span className='block text-[#F78F1E] drop-shadow-lg'>& trang thiết bị</span>
              </h1>
              <p className='mx-auto max-w-2xl text-lg leading-relaxed text-white/95 md:text-xl'>
                Môi trường học tập hiện đại, an toàn và đầy đủ tiện nghi cho sự phát triển toàn diện
                của trẻ
              </p>
            </motion.div>
            ...
            >
              {[
                { icon: Building2, label: 'Hiện đại', sublabel: 'Cơ sở vật chất' },
                { icon: Sparkles, label: 'An toàn', sublabel: 'Tiêu chuẩn cao' },
                { icon: Award, label: 'Chất lượng', sublabel: 'Đạt chuẩn' },
              ].map((item, index) => {
