  ...
  return (
    <section>
      ...
      >
        ...
        <div className="pointer-events-none absolute top-0 h-16 w-screen">
          <svg
            viewBox="0 0 1440 120"
            preserveAspectRatio="none"
            className="block h-full w-screen"
          >
            <path
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6 pb-28 pt-20">
          ...
          <div className="relative mb-12 flex items-center justify-center">
            <h2 className="text-center text-3xl font-extrabold text-emerald-700 md:text-5xl">
              Phương pháp dạy học
            </h2>

            {/* dotted swirl (animated draw + drifting dash) */}
            <motion.svg
              className="pointer-events-none absolute right-0 top-1 h-16 w-40 md:right-10 md:top-0 md:w-56"
              viewBox="0 0 220 80"
              fill="none"
              initial={{ opacity: 0 }}
            ...
            {METHODS.map((m, i) => (
              ...
              >
                ...
                >
                  ...
                  {/* quote */}
                  <p className="mt-2 whitespace-pre-line leading-snug text-gray-700">
                    {m.quote}
                  </p>
                </motion.div>
              </motion.div>
